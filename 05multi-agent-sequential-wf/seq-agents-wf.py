"""
NEW 07: multi-agent sequential workflow example Skilltech Lab
...
Simple multi agent sequential workflow example using Azure AI Agents.
Each agent performs a specific task in sequence:
"""
# Add references
# Add references
import asyncio
